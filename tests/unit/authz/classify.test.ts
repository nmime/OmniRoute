...
const cases: Case[] = [
  ...
  { name: "/api/v1/models GET public catalog", path: "/api/v1/models", expectedClass: "PUBLIC" },
  {
    name: "/api/v1/models POST stays client API",
    path: "/api/v1/models",
    method: "POST",
    expectedClass: "CLIENT_API",
  },
  ...
  {
    name: "/models alias GET public catalog",
    path: "/models",
    expectedClass: "PUBLIC",
    expectedNormalized: "/api/v1/models",
  },
  {
    name: "/models alias POST stays client API",
    path: "/models",
    method: "POST",
    expectedClass: "CLIENT_API",
    expectedNormalized: "/api/v1/models",
